...
import { useMergedDocuments } from '@/api/queries'
...
export default function Documents() {
  ...
  const { data: mergedDocuments, isLoading } = useMergedDocuments()
  ...
  return (
    <PageTransition className="space-y-6">
      ...
      {isLoading ? (
        ...
        <MergedDocumentList documents={filtered} />
      ) : (
        <EmptyState
          icon={FileStack}
