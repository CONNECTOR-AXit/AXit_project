      ...
      <form onSubmit={submitSearch} className="ml-auto hidden md:block lg:mr-auto lg:ml-8">
        <div className="relative w-[240px] xl:w-[320px]">
          ...
          <Input
            ...
            aria-label="통합 검색"
          />
          <kbd className="pointer-events-none absolute top-1/2 right-2.5 flex -translate-y-1/2 items-center gap-0.5 rounded bg-line-soft px-1.5 py-0.5 text-[10px] font-bold text-ink-subtle">
